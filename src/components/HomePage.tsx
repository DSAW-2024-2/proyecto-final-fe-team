      ...
      <div className='md:flex w-full justify-between space-x-4 mx-4 md:mx-20 hidden'>
        <div className='flex justify-between w-3/5 bg-green rounded-xl py-6 pr-11'>
          <div className='flex flex-col justify-end mb-4'>
            <p className='text-h1 text-blue font-bold w-full pl-8 md:pl-20'>Bienvenido {userName},</p>
            <p className='text-h2 text-blue w-full pl-8 md:pl-20'>¡Ten un lindo día!</p>
          </div>
          <img
            src="logoCircle.png"
        ...
        <div className='flex flex-col w-2/5 bg-blue rounded-xl pt-9 cursor-pointer transition-transform transform hover:scale-105 hover:shadow-lg'>
          <p className='text-h2 text-white font-bold w-full pl-8 md:pl-20'>Tu próximo viaje: </p>
          {nextTrip && (
            <SmallTravelCardText
              name={nextTrip.driverName}
              date={new Date(nextTrip.tripDate).toLocaleDateString('es-ES', { day: '2-digit', month: 'short' })}
